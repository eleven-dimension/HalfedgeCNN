...
if __name__ == "__main__":
    ...
    parser.add_argument('--cylinders', type=int, default=2000, help='Number of cylinders to generate')
    parser.add_argument('--pyramids', type=int, default=2000, help='Number of pyramids to generate')
